...
// 	Name string `json:"name" jsonschema:"required,description=The name of the member"`
// 	Age  int    `json:"age" jsonschema:"required,description=The age of the member"`
// }
...
// 	err = server.RegisterTool("add member", "add new member", func(ctx context.Context, args MemberData) (*mcp.ToolResponse, error) {
// 		svcs := member.NewMember()

// 		result, _ := svcs.AddMember(context.TODO(), args.Name)
